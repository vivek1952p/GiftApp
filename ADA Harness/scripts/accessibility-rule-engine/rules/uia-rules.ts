...
export const UiaButtonRule = nameRule(
  'uia-button-name',
  'Button',
  'Button has no accessible name',
  'critical'
);
export const UiaImageRule = nameRule(
  'uia-image-name',
  'Image',
  'Image may be missing alt text',
  'serious',
  '1.1.1',
  'Add a descriptive alt attribute (or empty alt="" if decorative).'
);
export const UiaInputRule = nameRule(
  'uia-input-name',
  'Edit',
  'Input field has no accessible label',
  'critical',
  '4.1.2',
  'Associate a <label> or add aria-label to the input.'
);
export const UiaCheckboxRule = nameRule(
  'uia-checkbox-name',
  'CheckBox',
...
export const UiaComboBoxRule = nameRule(
  'uia-combobox-name',
  'ComboBox',
  'Combobox has no accessible name',
  'serious'
);
export const UiaTreeItemRule = nameRule(
  'uia-treeitem-name',
  'TreeItem',
  'Tree item has no accessible name',
  'moderate'
);
export const UiaMenuItemRule = nameRule(
  'uia-menuitem-name',
  'MenuItem',
  'Menu item has no accessible name',
  'serious'
);
export const UiaTabRule = nameRule('uia-tab-name', 'TabItem', 'Tab has no accessible name', 'serious');
export const UiaHyperlinkRule = nameRule(
  'uia-link-name',
  'Hyperlink',
  'Hyperlink has no accessible name',
  'serious',
  '2.4.4',
  'Provide descriptive link text or aria-label.'
);
export const UiaSliderRule = nameRule(
  'uia-slider-name',
  'Slider',
  'Slider has no accessible name',
  'serious'
);
